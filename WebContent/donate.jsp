    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                        ...
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                <div class="nav-item dropdown show no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="true" href="#"><i class="icon-clock fa-fw" style="margin: 1px;"></i><label id="clock" style="margin: 3px;">Label</label></a>
                                    <div class="dropdown-menu dropdown-menu-right show dropdown-list dropdown-menu-right animated--grow-in"></div>
                                </div>
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-1">Payment Portal</h3>
            </div>
            <div class="col">
                <div class="alert alert-danger text-center" role="alert" style="display: none;"><span><strong>Card Number</strong>&nbsp;is invalid</span></div>
      ...
      <div class="col-lg-7 mx-auto">
            ...
            <div id="nav-tab-card" class="tab-pane fade show active">
              ...
              <form id="payment_form" role="form" method = "post">
                <div class="form-group">
                  ...
                  <input id = "name" type="text" name="username" placeholder="Full Name" required pattern="[a-zA-Z]+" title="Alphabets and Spaces only" class="form-control">
                </div>
                <div class="form-group">
                  <label for="cardNumber">Card number</label>
                  <div class="input-group">
                    <input id = "card_number" type="text" name="cardNumber" placeholder="Your card number" class="form-control" required pattern = "[0-9]{16}" title = "16 digit Card Number">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                      <input id = "amount" type="number" name="amount" placeholder="Enter Rs" class="form-control" required value = "100" min = "1" max="100000">
                      <div class="input-group-append">
                  ...
                  <div class="form-group">
                    <label for="contributionType">Choose a Cause</label>
                    <div class="input-group">
                  ...
                  <div class="col-sm-8">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input id="month" type="number" placeholder="MM" name="" class="form-control" required min="1" max = "12" value = "">
                        <input id="year" type="number" placeholder="YY" name="" class="form-control" required min="20" max = "99" value = "">
                      </div>
                    </div>
                  </div>
                  <div class="col-sm-4">
                    <div class="form-group mb-4">
                      <label data-toggle="tooltip" title="Three-digit code on the back of your card">CVV
                                                  <i class="fa fa-question-circle"></i>
                                              </label>
                      <input id="cvv" type="text" required pattern = [0-9]{3} title = "3 digits" class="form-control">
                    </div>
                  </div>
                ...
                <input id="confirm" type="submit" class="subscribe btn btn-primary btn-block rounded-pill shadow-sm" value = "Confirm"></button>
              </form>
            </div>
            <!-- End -->
          </div>
        ...
        <footer class="bg-white sticky-footer">
            <div class="container my-auto">
                <div class="text-center my-auto copyright"><span>Copyright © IUVA 2020</span></div>
            </div>
        </footer>
